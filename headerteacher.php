            ...
            <nav id="main-nav" class="navbar align-items-start sidebar sidebar-dark accordion  p-0" style="padding-bottom: 0px; ">
                <div class="container-fluid d-flex flex-column p-0">
                    ...
                    <ul class="navbar-nav text-light" id="accordionSidebar">
                        <li class="nav-item">
                            <a id="anchor1" class="nav-link" href="lecturer_subjects.php">
                                <i class="fas fa-book"></i>
                                <span>&nbsp;Subjects</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a id="anchor2" class="nav-link" href="lecturer_quizzes.php">
                                <i class="fas fa-pen"></i>
                                <span>Quizzes</span>
                            </a>
                        </li>
                    </ul>
                    <a class="btn btn-dark btn-dark btn-md" role="button" data-bss-hover-animate="pulse" href="index.php">Log Out</a>
